            ...
            <el-tab-pane label="input">
                <div>
                    ...
                    <div class="item">
                        ...
                        <span>{{transactionData.transTimestamp || ""}}</span>
                    </div>
                    <div class="item">
                        <span class="label">actionCount:</span>
                        <span>{{transactionData.actionCount || ""}}</span>
                    </div>
                    <div class="item" style="font-size: 0">
                        <span class="label">transactionActionList:</span>
                        <div class="detail-input-content">
                            <div  class="input-data" v-for='item in transactionData.transactionActionList' :key='item.chainCodeIDName'>
                                <div class="input-label">
                                    <span class="label">chainCodeIDName</span>
                                    <span>{{item.chainCodeIDName}}</span>
                                </div>
                                <div class="input-label">
                                    <span class="label">chainCodeIDPath</span>
                                    <span>{{item.chainCodeIDPath}}</span>
                                </div>
                                <div class="input-label">
                                    <span class="label">chainCodeIDVersion</span>
                                    <span>{{item.chainCodeIDVersion}}</span>
                                </div>
                                <div class="input-label">
                                    <span class="label">chainCodeInputArgs</span>
                                    <ul class="input-label-list">
                                        <li v-for="list in item.chainCodeInputArgs" :key='list' v-if='list == item.chainCodeInputArgs[0]'>
                                            <span class="input-label-list-title">functionName</span>
                                            <span class="input-label-list-content">{{list}}</span>
                                        </li>
                                        <li v-for="list in item.chainCodeInputArgs" :key='list' v-if='list != item.chainCodeInputArgs[0]'>
                                            <span class="input-label-list-title">params</span>
                                            <span>{{list}}</span>
                                        </li>
                                    </ul>
                                </div>
