        ...
        <div class="module-wrapper">
            ...
            <div class="search-table">
                <el-table :data="blockData" class="block-table-content" v-loading="loading" @row-click="clickTable" ref="refTable">
                    ...
                    <el-table-column prop="createTime" label="创建时间" width="280" :show-overflow-tooltip="true" align="center">
                        <template slot-scope="scope">
...
import { getBlockList } from "@/util/api";
    ...
    methods: {
        ...
        getBlockPage: function() {
            ...
            if(this.searchKey.value){
                if(this.searchKey.value.length===64){
