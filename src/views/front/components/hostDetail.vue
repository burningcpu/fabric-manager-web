...
import { getPerformanceRatio, nodesHealth } from "@/util/api";
...
export default {
    ...
    watch: {
        ...
        $route: function() {
            this.nodesQuery = this.$route.query;
        }
    },
    data() {
        return {
    ...
    methods: {
        ...
        getChartData() {
            ...
            console.log(this.nodesQuery)
            getPerformanceRatio(this.nodesQuery.frontId, reqQurey)
                .then(res => {
